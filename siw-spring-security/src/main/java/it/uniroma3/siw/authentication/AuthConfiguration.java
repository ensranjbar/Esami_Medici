...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**", "/images/**","/contatti").permitAll()
                .antMatchers(HttpMethod.GET, "/medico", "/medici", "/medico/{id}", "/tipologia", "/tipologie", "/tipologia/{id}", "/register").permitAll()
